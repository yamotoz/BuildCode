  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center gap-1 text-[10px] font-mono" style={{ color: t.textSecondary }}>
      ...
      <div className="mt-4 flex gap-4 text-[10px] font-mono" style={{ color: t.tickFill }}>
